# Awesome Vietnam Dev [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> Danh sách tài nguyên lập trình chất lượng cao dành cho lập trình viên Việt Nam.

Đóng góp? Xem [CONTRIBUTING.md](CONTRIBUTING.md) — mọi PR đều được chào đón!
...
- [awesome-vietnam-dev](https://github.com/truonganDevOps/awesome-vietnam-dev) - Repo này!
- [laravel-vite-starter](https://github.com/laravel/laravel) - Laravel với Vite build tool.
- [create-react-app](https://create-react-app.dev) - Khởi tạo React app nhanh.
- [LAMP Stack Docker](https://github.com/sprintcube/docker-compose-lamp) - LAMP stack với Docker Compose.
- [Vietnameses Coder Tools](https://viblo.asia/tags/tools) - Tổng hợp công cụ từ Viblo.

## Tài nguyên phỏng vấn

- [Viblo Interview](https://viblo.asia/tags/interview) - Bộ câu hỏi phỏng vấn kỹ thuật từ cộng đồng.
- [Top100 Vietnam IT Companies](https://itviec.com/it-companies/ho-chi-minh-city) - Danh sách công ty IT hàng đầu.
- [Grokking System Design (VI)](https://viblo.asia/tags/system-design) - System design bằng tiếng Việt.
- [Roadmap.sh](https://roadmap.sh) - Lộ trình học các tech stack phổ biến (có bản dịch).
...
Xem [CONTRIBUTING.md](CONTRIBUTING.md) để biết cách thêm tài nguyên vào danh sách này.
